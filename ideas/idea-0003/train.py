...
def run_phase(phase: str, run_dir: str, config_path: str, attempt_id: str) -> dict:
    ...
    artifact.write_text(json.dumps({
        ...
        "novelty_claims": ['Combine non-default mechanisms around: invent, topology-mixed, language, recurrent', 'Reject template decoder-only stacks with only cosmetic changes.', 'Use explicit originality rationale before implementation starts.'],
